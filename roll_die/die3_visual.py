...
results = [die_1.roll_die() + die_2.roll_die() + die_3.roll_die() for roll_num in range(50_000)]
...
# Adding a title
my_layout = Layout(title='Result for rolling three pair dies with sides (D6), 50000 times', 
					xaxis=x_axis_config)
